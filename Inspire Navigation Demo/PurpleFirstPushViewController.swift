//
//  PurpleFirstPushViewController.swift
...
class PurpleFirstPushViewController: UIViewController {
    ...
    @objc func pushToNextVC() {
        self.navigationController?.pushViewController(PurpleSecondPushViewController(), animated:
            true)
    }
